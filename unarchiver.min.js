...
(function(){
  ...
  async function extractRarFile(file){
    ...
    var allow = {cfg:1,dat:1,cff:1,log:1,hdr:1,inf:1,txt:1};
    var out=[];
    ...
    if(!out.length) throw new Error('Đã mở được RAR nhưng không thấy CFG/DAT/CFF/LOG/HDR/INF/TXT bên trong.');
    return out;
  }
